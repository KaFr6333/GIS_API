...
<qgis simplifyLocal="1" labelsEnabled="0" simplifyAlgorithm="0" simplifyDrawingTol="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" version="3.16.11-Hannover" minScale="100000000">
  ...
  <DiagramLayerSettings linePlacementFlags="18" zIndex="0" placement="2" priority="0" obstacle="0" showAll="1" dist="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="access" name="" index="4"/>
    <alias field="vehicle" name="" index="5"/>
    <alias field="motor_vehi" name="" index="6"/>
    <alias field="railway" name="" index="7"/>
    <alias field="abandoned_" name="" index="8"/>
    <alias field="lane_marki" name="" index="9"/>
    <alias field="cycleway_b" name="" index="10"/>
    <alias field="oneway" name="" index="11"/>
    <alias field="hgv" name="" index="12"/>
    <alias field="service" name="" index="13"/>
    <alias field="maxspeed" name="" index="14"/>
    <alias field="bus" name="" index="15"/>
    <alias field="noexit" name="" index="16"/>
    <alias field="embankment" name="" index="17"/>
    <alias field="width" name="" index="18"/>
    <alias field="segregated" name="" index="19"/>
    <alias field="moped" name="" index="20"/>
    <alias field="foot" name="" index="21"/>
    <alias field="bicycle" name="" index="22"/>
    <alias field="name" name="" index="23"/>
    <alias field="ref" name="" index="24"/>
    <alias field="unsigned_r" name="" index="25"/>
    <alias field="surface" name="" index="26"/>
    <alias field="junction" name="" index="27"/>
    <alias field="tracktype" name="" index="28"/>
    <alias field="motorcycle" name="" index="29"/>
    <alias field="motorcar" name="" index="30"/>
  </aliases>
  <defaults>
